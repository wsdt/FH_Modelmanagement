setTimeout(function() {
  ...
  document.getElementById(
    "es-dynamic-modules-test"
  ).textContent = supportsDynamicImports();
  document.getElementById("shadow-dom-test").textContent = !!document.head
    .attachShadow;
  document.getElementById(
    "custom-elements-test"
  ).textContent = !!window.customElements;
