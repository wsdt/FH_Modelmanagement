...
var ProfilePic = /** @class */ (function () {
    ...
    ProfilePic.prototype.render = function () {
        ...
        return <img src={this.get_profile_pic_uri()} alt={this.alt_msg} class={this.class_name}/>;
    };
    __decorate([
        core_1.Prop()
    ], ProfilePic.prototype, "alt_msg", void 0);
    __decorate([
        core_1.Prop()
    ], ProfilePic.prototype, "user_name", void 0);
    __decorate([
        core_1.Prop()
    ], ProfilePic.prototype, "class_name", void 0);
